...
% ~\autocite{}
\addbibresource{references.bib} % or MRONJ.bib
...
\begin{outline}
    \1 to target on rapidly proliferating cells
        ...
        \2 the basal cells of the mucosal layer
        \2 the acinar and ductal cells of the salivary glands
...
\begin{outline}
    ...
    \1 patients with MRONJ: range from minor local debridement to total removal of all necrotic bones with closure by primary intention
